...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email'             => ['nullable', 'email', 'regex:/^(?!.*[\/]).+@(?!.*[\/]).+\.(?!.*[\/]).+$/i', 'unique:users,email,NULL,id,deleted_at,NULL'],
            'mobile_number'     => ['required', 'numeric', 'regex:/^[0-9]+$/', 'digits_between:8,12', 'unique:users,mobile_number,NULL,id,deleted_at,NULL'],
            'security_pin'      => ['required', 'numeric', 'digits:6', 'unique:users,security_pin,NULL,id,deleted_at,NULL'],
