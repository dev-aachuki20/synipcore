...
@section('title', trans('cruds.menus.delivery_managements'))
        ...
        <div class="col-12">
            <div class="card mt-20">
                <div class="card-header">
                    <h4 class="mb-0">@lang('cruds.delivery_management.title')</h4>
                </div>
                <div class="card-body">
...
@section('custom_js')
    ...
    <script type="text/javascript">
        @can('delivery_management_delete')
            $(document).on("click", ".btnDeleteDeliveryManagement", function(e) {
                e.preventDefault();
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        $('#delivery-management-table').DataTable().ajax.reload(null,
                                            false);
