...
@section('title', trans('cruds.menus.guards'))
    ...
    <div class="col-12">
        <div class="card mt-20">
            <div class="card-header">
                <h4 class="mb-0">@lang('cruds.guard.title')</h4>
            </div>
            <div class="card-body">
...
@section('custom_js')
    ...
    <script type="text/javascript">
        @can('guard_delete')
            $(document).on("click", ".btnDeleteGuard", function(e) {
                e.preventDefault();
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        $('#guard-table').DataTable().ajax.reload(null, false);
