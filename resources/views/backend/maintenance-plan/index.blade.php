...
@section('title', trans('cruds.menus.maintenance_plans'))
        ...
        <div class="col-12">
            <div class="card mt-20">
                <div class="card-header">
                    <h4 class="mb-0">@lang('cruds.maintenance_plan.title')</h4>
                </div>
                <div class="card-body">
...
@section('custom_js')
    ...
    <script type="text/javascript">
        @can('maintenance_plan_delete')
            $(document).on("click", ".btnDeleteMaintenancePlan", function(e) {
                e.preventDefault();
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        $('#maintenance-plan-table').DataTable().ajax.reload(null,
                                            false);
