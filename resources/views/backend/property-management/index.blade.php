    ...
    <div class="col-12">
        <div class="card mt-20">
            <div class="card-header">
                <h4 class="mb-0">@lang('cruds.property_management.title')</h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    @can('property_management_delete')
    $(document).on("click", ".btnDeletePropertyManagement", function(e) {
        e.preventDefault();
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                $('#property-management-table').DataTable().ajax.reload(null, false);
