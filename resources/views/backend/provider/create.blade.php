        ...
        <div class="col-12">
            <div class="card mt-20">
                <div class="card-header">
                    <h4 class="mb-0">@lang('global.add') @lang('global.new') @lang('cruds.provider.title_singular')</h4>
                </div>
                <div class="card-body">
                    <form method="POST" class="msg-form" id="providerAdd" data-url="{{ route('admin.providers.store') }}">
                        @csrf
