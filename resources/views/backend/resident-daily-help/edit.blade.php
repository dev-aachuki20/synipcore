        ...
        <div class="col-12">
            <div class="card mt-20">
                <div class="card-header">
                    <h4 class="mb-0">@lang('global.edit') @lang('global.new') @lang('cruds.resident_daily_help.title_singular')</h4>
                </div>
                <div class="card-body">
                    <form method="POST" class="msg-form" id="ResidentDailyHelpEdit" data-url="{{ route('admin.resident-daily-helps.update', [$residentDailyHelp->uuid]) }}">
                        @method('PUT')
                        @csrf
