        ...
        <div class="col-12">
            <div class="card mt-20">
                <div class="card-header">
                    <h4 class="mb-0">@lang('global.edit') @lang('global.new') @lang('cruds.service.title_singular')</h4>
                </div>
                <div class="card-body">
                    <form class="msg-form" id="serviceEdit" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="id" value="{{$service->uuid}}">
...
@section('custom_js')
    ...
    <script>
        $('#serviceEdit').on('submit', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.services.update', $service->uuid) }}",
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
