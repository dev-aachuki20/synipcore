...
@section('email-content')
    ...
    <div class="regards" style="font-family: 'Barlow', sans-serif; color: #464B70; line-height: 10.5px; font-weight: 700; font-size: 18px;">Regards,<br><br><br> {{ getSetting('site_title') ? getSetting('site_title') : config('app.name') }}</div>
